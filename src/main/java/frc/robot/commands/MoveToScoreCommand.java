...
public class MoveToScoreCommand extends Command{
    ...
    public MoveToScoreCommand(SwerveDriveSubsystem swerve){
        ...
        targetPose = new Pose2d(swerve.getNearestScoringPoint().x,swerve.getNearestScoringPoint().y, new Rotation2d(swerve.getRotationToPoint(SwerveDriveSubsystem.getHubPoint())));
