...
public class RobotContainer {
        ...
        private void configureBindings() {
                ...
                Command driveFieldOrientedAngularVelocityCommand = swerveDriveSubsystem
                ...
                m_pitController.povUp()
                                .whileTrue(new RunCommand(() -> swerveDriveSubsystem
                                                .driveRobotRelative(new ChassisSpeeds(1, 0, 0))));
                m_pitController.povUp()
                                .onFalse(new InstantCommand(() -> swerveDriveSubsystem
